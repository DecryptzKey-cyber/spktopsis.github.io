...
CREATE TABLE `kriteria` (
  `id` int(11) NOT NULL,
  `ukuran_memori` varchar(25) NOT NULL,
  `tipe_memori` varchar(25) NOT NULL,
  `bus_memori` varchar(25) NOT NULL,
...
INSERT INTO `kriteria` (`id`, `ukuran_memori`, `tipe_memori`, `bus_memori`, `bandwidth`, `harga`) VALUES
(2, '3', '4', '3', '14', '20000000');
...
INSERT INTO `penilaian` (`id`, `merek`, `ukuran_memori`, `tipe_memori`, `bus_memori`, `bandwidth`, `harga`) VALUES
(2, 'Lenovo', '2', '4', '4', '3', '3'),
(3, 'Acer', '5', '4', '3', '3', '5');
