                ...
                <div class="card-body">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            $pembagi5 = null;
                            //ukuran_memori
                            $resultRam = $conn->query("SELECT ukuran_memori FROM penilaian");
                            ...
                            //tipe_memori
                            $resultSSD = $conn->query("SELECT tipe_memori FROM penilaian");
                            ...
                            //bus_memori
                            $resultProcessor = $conn->query("SELECT bus_memori FROM penilaian");
                            ...
                            //bandwidth
                            $resultULayar = $conn->query("SELECT bandwidth FROM penilaian");
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td><?= $penilaian['ukuran_memori'] / $pembagi1 ?></td>
                                        <td><?= $penilaian['tipe_memori'] / $pembagi2 ?></td>
                                        <td><?= $penilaian['bus_memori'] / $pembagi3 ?></td>
                                        <td><?= $penilaian['bandwidth'] / $pembagi4 ?></td>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            if ($resultKriteria->num_rows > 0) {
                                ...
                                $c1 = $kriteria['ukuran_memori'];
                                $c2 = $kriteria['tipe_memori'];
                                $c3 = $kriteria['bus_memori'];
                                $c4 = $kriteria['bandwidth'];
                                $c5 = $kriteria['harga'];
                            }
                            ...
                            if ($resultPenilaian->num_rows > 0) {
                                while ($penilaian = $resultPenilaian->fetch_assoc()) {
                                    $matriksC1 = ($penilaian['ukuran_memori'] / $pembagi1) * $c1;
                                    $matriksC2 = ($penilaian['tipe_memori'] / $pembagi2) * $c2;
                                    // MAINTENANCE ============================
                                    $matriksC3 = ($penilaian['bus_memori'] / $pembagi3) * $c3;
                                    $matriksC4 = ($penilaian['bandwidth'] / $pembagi4) * $c4;
